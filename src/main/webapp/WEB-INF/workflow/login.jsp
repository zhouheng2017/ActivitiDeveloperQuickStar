...
<div style="width: 500px">
    ...
    <form class="bs-example bs-example-form" role="form" action="${ctx}/user/login" method="post">
        ...
        <div class="input-group">
            ...
            <input type="text" style="width:20%" class="form-control" name="user" value="zhouheng">
        </div>
        <br>
        <div class="input-group">
            <span class="input-group-addon">密码</span>
            <input type="password" style="width:20%" class="form-control" name="password" value="password">
        </div>
        <div class="input-group">
            <br/>
            <input type="submit" class="btn btn-primary" value="submit">
