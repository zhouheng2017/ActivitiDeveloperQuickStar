  ...
  <div class="navbar-inner">
      <div class="container-fluid">
        ...
        <div class="nav-collapse">
          <ul class="nav">
            <li class="active"><a href="#" rel="workflow/index2.action"><i class="icon-home icon-black"></i>首页</a></li>
            <li><a href="#" rel="workflow/myTask"><i class="icon-th-list icon-black"></i>任务列表</a></li>
            <li class="dropdown">
              <a data-toggle="dropdown" class="dropdown-toggle" href="#"><i class="icon-th-large icon-black"></i>管理<b class="caret"></b></a>
              <ul class="dropdown-menu">
                <li><a href="#" rel='workflow/processList'>流程定义</a></li>
              </ul>
            </li>
          </ul>
